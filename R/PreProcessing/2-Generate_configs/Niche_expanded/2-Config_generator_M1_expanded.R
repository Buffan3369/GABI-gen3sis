################################################################################
# Goal: Generate configs for simulations starting in NA generated under M1 with 
...
param_df$omega_T <-    linMap(as.numeric(param_df$omega_T), from = 0.01, to = 0.6, rnd = T, dgts = 3)
...
if(!dir.exists("./Data/Gen3sis_parameter_tables/Niche_expanded/M1")){dir.create("./Data/Gen3sis_parameter_tables/Niche_expanded/M1")}
write.tbl.std(param_df, 
              paste0("./Data/Gen3sis_parameter_tables/Niche_expanded/M1/", start_region, "_parameters.txt"))
## Generate config files -----------------------------------------------------
out <- paste0("./Data/Gen3sis_configs/Niche_expanded/M1/", start_region, "_start/")
...
for(i in 1:n){
  ...
  config_i <- readLines(paste0("./Data/Gen3sis_configs/Niche_expanded/M1/config_M1_", start_region, "_template.R"))
