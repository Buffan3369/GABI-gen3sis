...
if(!dir.exists("./Data/Gen3sis_parameter_tables/Niche_expanded/M0")){dir.create("./Data/Gen3sis_parameter_tables/Niche_expanded/M0")}
write.tbl.std(param_df,
            paste0("./Data/Gen3sis_parameter_tables/Niche_expanded/M0/", start_region, "_parameters.txt"))
## Generate config files -------------------------------------------------------
out <- paste0("./Data/Gen3sis_configs/Niche_expanded/M0/", start_region, "_start")
for(i in 1:n){
