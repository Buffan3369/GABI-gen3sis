...
# Initialise
run <- 1
path_to_pa <- paste0("../Outputs/", model, "/", from, "_America_start/config_", model, "_", from, "_America_run_", run, "/pa_matrices/")
...
# Save xyz tbl
saveRDS(pa_0, paste0("../Outputs/all_starting_ranges/", model, "_", from, "_America_start_xyz.RDS"))
