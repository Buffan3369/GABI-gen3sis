...
# Goal: Display, for Oscillayers-based simulations, the three postprocessing metrics:
...
library(tidyverse)
source("./R/PostProcessing/4b-Distrib_moments_Oscillayers.R")
...
ggsave("./Figures/MS/Supp/Oscillayers/Figure_metrics_oscillayers.pdf", 
       plot = full_panel, height = 200, width = 100, units = "mm")
