...
for(start_region in c("North_America", "South_America")){
  ...
  if(!dir.exists("./Data/Gen3sis_parameter_tables/M2")){dir.create("./Data/Gen3sis_parameter_tables/M2")}
  write.tbl.std(param_df, 
                paste0("./Data/Gen3sis_parameter_tables/M2/", start_region, "_parameters.txt"))
  ## Generate config files -----------------------------------------------------
  out <- paste0("./Data/Gen3sis_configs/M2/", start_region, "_start/")
  ...
  for(i in 1:n){
    ...
    config_i <- readLines(paste0("./Data/Gen3sis_configs/M2/config_M2_", start_region, "_template.R"))
