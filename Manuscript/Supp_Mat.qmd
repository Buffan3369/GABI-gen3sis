...
#| out-height: 6.5cm
#| out-width: 15cm
#| fig-cap: Ancestral species' distance to isthmus distribution of simulations either starting in North or South America, either resulting from our random equal-area sampling scheme (*top*) or from our spatial standardisation procedure (*bottom*) (see @sec-methods). Black dots and error bars respectively show mean estimates and their student-derived 95% confidence interval.
