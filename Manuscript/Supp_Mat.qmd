...
#| out-height: 6cm
#| out-width: 14cm
#| fig-cap: Distribution of the distance to isthmus of the ancestral species of simulations either starting in North or South America, resulting from our random equal-area sampling scheme (see Method details). Dashed lines on top and bottom of the distribution represent the 25% and 75% quantiles whereas the thicker full line in the middle shows the median (50% quantile).

knitr::include_graphics("../Figures/dist_to_isthm/All_starting_ranges.png")
...
#| out-height: 7cm
#| out-width: 14cm
#| fig-cap: Diversity in the colonised area following a successful interchange (decimal log scale). Dashed lines on top and bottom of the distribution represent the 25% and 75% quantiles whereas the thicker full line in the middle shows the median (50% quantile).
...
#| out-height: 7cm
#| out-width: 14cm
#| fig-cap: Distance to the isthmus for non-successful simulations -- *i*.*e*., that did not result in a significant interchange. Dashed lines on top and bottom of the distribution represent the 25% and 75% quantiles whereas the thicker full line in the middle shows the median (50% quantile).
...
#| out-height: 17cm
#| out-width: 23cm
#| fig-cap: Biome where the ancestral species of each of the 500 simulation originated, for each continent and each scenario.

knitr::include_graphics("../Figures/starting_biome/starting_biome_ALL.png")
```
...
#| out-height: 17cm
#| out-width: 23cm
#| fig-cap: Biome where the ancestral species of each simulation leading to a successful exchange originated, for each continent and each scenario.

knitr::include_graphics("../Figures/starting_biome/starting_biome_EXCH.png")
```
