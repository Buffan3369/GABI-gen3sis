...
#| out-height: 13cm
#| out-width: 20cm
#| fig-cap: Distribution of the distance to isthmus of the ancestral species of simulations either starting in North or South America, either resulting from our random equal-area sampling scheme (*top*) or from our spatial standardisation procedure (*bottom*) (see Method details). Black dots in the middle of the distribtions are mean estimates, and error bars represent their student-derived 95% confidence interval.
